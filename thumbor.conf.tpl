...
## accepts it (via Accept header)
## Defaults to: True
AUTO_AVIF  = {{ AUTO_AVIF  | default(True) }}
...
## Defaults to: None
ACCESS_CONTROL_ALLOW_ORIGIN_HEADER = {{ ACCESS_CONTROL_ALLOW_ORIGIN_HEADER | default(False) }}
...
## Mixed Storage signing key storage. This must be the full name of a python module
## (python must be able to import it)
## Defaults to: thumbor.storages.no_storage
MIXED_STORAGE_CRYPTO_STORAGE = '{{ MIXED_STORAGE_CRYPTO_STORAGE | default('thumbor.storages.no_storage') }}'

## Mixed Storage detector information storage. This must be the full name of a python module
## (python must be able to import it)
## Defaults to: thumbor.storages.no_storage
...
## Defaults to: False
ALLOW_OLD_URLS = {{ ALLOW_OLD_URLS | default(False) }}
...
RESULT_STORAGE_FILE_STORAGE_ROOT_PATH = '{{ RESULT_STORAGE_FILE_STORAGE_ROOT_PATH | default('/data/result') }}'
...
#'thumbor.detectors.face_detector',
#]
DETECTORS = {{ DETECTORS | default(['thumbor.detectors.feature_detector','thumbor.detectors.face_detector']) }}
...
## Defaults to: None
SENTRY_DSN_URL = {{ SENTRY_DSN_URL | default(None) }}
...
REDIS_QUEUE_MODE = '{{ REDIS_QUEUE_MODE | default('single_node') }}'
...
## Defaults to: localhost:23679,localhost:23680
REDIS_QUEUE_SENTINEL_INSTANCES = '{{ REDIS_QUEUE_SENTINEL_INSTANCES | default('localhost:23679,localhost:23680') }}'

## Sentinel server password for the queued redis detector
## Defaults to: None
REDIS_QUEUE_SENTINEL_PASSWORD = {{ REDIS_QUEUE_SENTINEL_PASSWORD | default(None) }}

## Sentinel server master instance for the queued redis detector
## Defaults to: masterinstance
REDIS_QUEUE_SENTINEL_MASTER_INSTANCE = '{{ REDIS_QUEUE_SENTINEL_MASTER_INSTANCE | default('masterinstance') }}'

## Sentinel server master password for the queued redis detector
## Defaults to: None
REDIS_QUEUE_SENTINEL_MASTER_PASSWORD = {{ REDIS_QUEUE_SENTINEL_MASTER_PASSWORD | default(None) }}

## Sentinel server master database index for the queued redis detector
## Defaults to: 0
REDIS_QUEUE_SENTINEL_MASTER_DB = {{ REDIS_QUEUE_SENTINEL_MASTER_DB | default(0) }}

## Sentinel server socket timeout for the queued redis detector
## Defaults to: 10.0
REDIS_QUEUE_SENTINEL_SOCKET_TIMEOUT = {{ REDIS_QUEUE_SENTINEL_SOCKET_TIMEOUT | default(10.0) }}
